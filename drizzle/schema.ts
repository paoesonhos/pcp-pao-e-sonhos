...
export const mapaBase = mysqlTable("mapa_base", {
  ...
  quantidade: decimal("quantidade", { precision: 10, scale: 2 }).notNull(), // Qtd Importada (original)
  qtdPlanejada: decimal("qtdPlanejada", { precision: 10, scale: 2 }).notNull(), // Qtd Planejada (com shelf life)
